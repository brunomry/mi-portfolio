...
const proyectos = [
  ...
  },
  {
    ...
    proyecto: "Individual",
    responsabilidades: ["El diseño fue replicado de una aplicación existente.", "Lógica desarrollada mediante manipulación del DOM", "Utilicé delegación de eventos para manejar los botones del temporizador","Agregué en el menú de navegación las opciones para redirigir a aplicaciones desarrolladas de reloj y cronómetro."],
