...
const projects = [
  {
    ...
    name: "Sistema de pedidos para hamburguesería",
    ...
    project: "Freelance",
    problem: "La hamburguesería necesitaba concentrar su menú y la recepción de pedidos en un canal más ordenado, sin perder la cercanía y simplicidad de WhatsApp.",
  ...
  },
  {
    ...
    name: "Comprobante online para servicio técnico",
  ...
  },
  {
    ...
    name: "Propuesta de optimización web para alojamiento en Cafayate",
    ...
    project: "Freelance",
    problem: "El sitio dispone de información sobre los alojamientos, pero la forma de comunicarla puede dificultar que el visitante comprenda rápidamente la propuesta, encuentre la opción adecuada y finalice el recorrido con una consulta por WhatsApp.",
    ...
    description: "Análisis en curso del sitio web de un alojamiento de Cafayate, orientado a evaluar cómo se comunican sus distintas opciones, la claridad y consistencia de la información y el recorrido hacia la consulta por WhatsApp. El trabajo concluirá con un informe de oportunidades y recomendaciones priorizadas, que servirá como guía para optimizar el sitio existente o desarrollar una nueva experiencia desde cero.",
    ...
    responsabilities: ["Evaluación de la propuesta de valor y de la claridad del mensaje principal.", "Revisión de la jerarquía, redacción y consistencia de la información entre páginas.", "Análisis del recorrido desde la exploración de alojamientos hasta la consulta por WhatsApp.", "Priorización de oportunidades de mejora.", "Elaboración de un informe aplicable por el proveedor actual o como base para una nueva implementación."],
    features: [],
