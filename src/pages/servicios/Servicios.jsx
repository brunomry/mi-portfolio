...
function Servicios() {
  return (
    ...
    >
      ...
      <div className="flex flex-col w-[100%] md:gap-2 xl:w-[100%] 2xl:w-[80%] containerServices h-[250px] mt-8 sm:h-[100%] pb-[20px] md:justify-center md:items-center gap-3 lg:gap-3 xl:gap-4 ">
