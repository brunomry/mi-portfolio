...
const Proyectos = () => {
  ...
  return (
    <section className="w-[100%] lg:w-[80%] py-3 flex flex-col gap-3 xl:gap-4 items-center px-3 xl:w-[80%] md:py-[100px] fondo mainSection">
      <div className="w-[100%] min-h-[100%] lg:w-[80%] rounded-[10px] lg:px-10 lg:py-10 lg:shadow-xl lg:bg-[white]">
        <h1 className="mb-6 md:mb-8 font-bold text-[18px] md:text-[25px] xl:text-[30px] 2xl:text-[40px] text-[#333]">
