...
const Tecnologias = () => {
  ...
  return (
    <section
      className="w-[100%] md:w-[90%] xl:w-[80%] min-h-[100vh] bg-[#fff] text-[#028891] flex flex-col md:gap-2 items-center tecnologias py-[100px]  mb-[20px]"
    >
      ...
      <div className="flex containerTech xl:w-[100%] h-[200px] sm:h-[100%] gap-2 md:gap-3 items-center sm:flex-wrap lg:pt-5 px-5 ">
       ...
       {filtrarTecnologiasPorCategoria("colaboracion").length > 0 && filtrarTecnologiasPorCategoria("colaboracion").map((tech, pos) => (
         <div key={pos}>
            <p className="rounded-[20px] border py-2 px-4  w-[fit-content] text-[#787777] md:text-[1rem] xl:text-[1.125rem]">{tech.name}</p>
          </div>
       ))}
     </div>
      </article>
