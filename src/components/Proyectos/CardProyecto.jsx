...
const CardProyecto = ({ proyecto }) => {
  ...
  return (
    <>
     <div onClick={openWeb} className="border-[#028891] border-[1px] rounded-md w-[100%] min-w-[280px] h-[425px] bg-[#f7f7f7] duration-[0.8s] sm:w-[300px] lg:w-[300px] lg:min-h-[300px] lg:duration-[0.7s] xl:w-[350px] cursor-pointer  hover:shadow-xl">
      <img
        src={proyecto.imagen}
        alt={proyecto.nombre}
      ...
      <div className="flex flex-col justify-between gap-6 mt-3">
        <div className=" rounded-[4px] py-1 px-2 flex flex-col items-center mb-2">
          <h4 className="mb-1 font-bold text-[20px] md:text-2xl text-[#028891]">{proyecto.nombre}</h4>
        ...
        <div className="flex justify-center gap-2 xl:gap-3">
          ...
          <button
            className="hidden md:flex md:text-[18px] lg:text-[20px] rounded-[6px] px-3 border-[1px] text-[#028891] border-[#028891] duration-[0.5s] hover:duration-[0.5s] hover:bg-[#028891] hover:text-[#fff] hover:border-[#000]  flex-col items-center "
