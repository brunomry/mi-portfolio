      ...
      {[false, "sm"].map((expand) => (
        <Navbar expand="lg" className="navBar d-flex justify-content-center ">
          ...
          >
            ...
            <Nav.Link href="#sobremi" className="fw-bold mb-xl-2 navLink text-center">
              Acerca de mí
            </Nav.Link>
            <Nav.Link href="#tecnologias" className="fw-bold  mb-xl-2 navLink text-center ">
              Tecnologías
            </Nav.Link>
            <Nav.Link href="#proyectos" className="fw-bold mb-xl-2 navLink text-center ">
              Proyectos
            </Nav.Link>
            <Nav.Link
            ...
            <Nav.Link href="#contacto" className="fw-bold mb-xl-2 navLink text-center" >
              Contacto
            </Nav.Link>
            </div>
          </Nav>
