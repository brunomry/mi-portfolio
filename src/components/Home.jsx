...
const Home = () => {
  return (
    <article
      className="d-flex flex-column justify-content-center align-items-center flex-md-row home pb-2 pb-md-3 rounded-3 shadow section1"
      id="sobremi"
    >
      <div className="d-flex flex-column flex-md-row align-items-center home_presentation">
        <div className="text-center">
          ...
          <img src={perfil} alt="" className="imgProfile mb-3 shadow" />
          <h2 className="display-6 fw-bold">Desarrollador Web Frontend</h2>
            <p className="fs-5">
