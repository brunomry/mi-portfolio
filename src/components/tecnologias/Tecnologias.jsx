...
const Tecnologias = () => {
  return (
    <article
      className="w-[100%] md:px-[150px] py-40 min-h-[50vh] bg-[#0a0a0a] text-[#028891] flex flex-col md:gap-2 px-4 md:min-h-[80vh] tecnologias lg:min-h-[100vh] xl:min-h-[80vh]"
      id="tecnologias"
    >
      ...
      <div className="flex containerTech w-[100%] h-[200px] sm:h-[100%] gap-2 md:gap-3 xl:gap-6 items-center sm:flex-wrap lg:pt-5 2xl:pt-14">
