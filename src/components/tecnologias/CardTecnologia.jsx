const CardTecnologia = ({ tech }) => {
  return (
    <figure
      key={tech.name}
      title={tech.name}
      className="shadow-xl px-5 text-center tech w-[100%] min-w-[150px] max-w-[150px] h-[150px] xl:max-w-[175px] xl:h-[150px] duration-[1s] bg-[#ffffff] border-[1px] rounded-xl flex flex-col justify-center items-center "
    >
