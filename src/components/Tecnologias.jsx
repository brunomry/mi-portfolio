...
const Tecnologias = () => {
  return (
    <article className="d-flex flex-column gap-3 align-items-center justify-content-center py-5 section">
      <h2 className="display-5">Tecnologías adquiridas</h2>
      <div className="d-flex flex-column align-items-center">
        <div className="d-flex flex-column flex-lg-row gap-3 gap-lg-5 align-items-center justify-content-start w-100">
