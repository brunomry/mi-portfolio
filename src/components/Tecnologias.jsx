...
const Tecnologias = () => {
  return (
    ...
    >
      ...
      <div className="flex containerTech w-[100%] h-[250px] sm:h-[100%] gap-2 md:gap-3 xl:gap-6 items-center sm:justify-center sm:flex-wrap pt-4 lg:pt-10 px-5 ">
      ...
      <div className="flex containerTech w-[100%] h-[250px] sm:h-[100%] sm:flex-wrap gap-2 md:gap-3 xl:gap-6 items-center sm:justify-center pt-4 px-5 ">
