...
const Tecnologias = () => {
  return (
    <article
      className="w-[100%] md:w-[90%] min-h-[50vh] bg-[#fff] text-[#028891] flex flex-col md:gap-2 items-center py-4 tecnologias sm:min-h-[100vh] lg:py-10 "
      id="tecnologias"
    >
      <h2 className="font-bold mb-4 text-[27px] md:text-[35px] lg:text-[38] xl:text-[40px] text-[#333]">
        Tecnologías
      </h2>
      ...
      <h3 className="px-2 md:px-10 text-[#444] me-auto font-bold mt-3 sm:flex-wrap md:text-[25px] lg:text-[28px]">
