...
const Certificaciones = () => {
  return (
    <article
      className="py-8 px-4 flex flex-col md:py-20 md:px-8 xl:py-40 lg:px-[100px] xl:px-[150px] w-[100%] min-h-[35vh] sm:min-h-[50vh] md:min-h-[50vh] lg:min-h-[40vh] mt-3 lg:mt-0 bg-[#0a0a0a] gap-2 sm:gap-4 certifications "
      id="certificaciones"
    >
