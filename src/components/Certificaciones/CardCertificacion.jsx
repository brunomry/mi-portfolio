...
const CardCertificacion = ({ certificado }) => {
  return (
    <div className="border-0 card px-2 pt-2 py-md-2 cardCertification  d-flex px-2 px-xl-5 shadow">
      ...
      <div className="mt-5 mt-sm-0 d-flex justify-content-center justify-content-md-end mb-2">
