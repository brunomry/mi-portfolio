...
const CardCertificacion = ({ certificado }) => {
  ...
  return (
    <div className="rounded-[6px] pt-6 md:pb-2 cardCertification w-[100%] min-w-[260px] h-[250px] duration-[0.8s] bg-[#F7F7F7] text-center md:text-start flex flex-col px-2 md:px-4 xl:px-10 shadow-xl lg:w-[75%] lg:h-[225px] xl:w-[60%]">
