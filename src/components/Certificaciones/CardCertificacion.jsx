...
const CardCertificacion = ({ certificado }) => {
  ...
  return (
    <div className="rounded-[6px] bg-[#fff] pt-6 md:pb-2 cardCertification w-[100%] min-w-[260px] h-[225px] md:h-[200px] duration-[0.8s] border-[1px] border-s-[#69bac0] border-s-[5px] text-center md:text-start flex flex-col px-2 md:px-4 xl:px-10 shadow-xl lg:w-[75%] xl:w-[65%]">
      ...
      <div className="flex justify-center mt-5 mb-2 sm:mt-0 sm:justify-end">
        <button onClick={mostrarCertificacion} className="w-[100%] md:w-[initial] text-center rounded-[6px] bg-[#028891] md:text-[18px] text-white hover:bg-[#fff] hover:border hover:border-[#028891] hover:text-[#028891] px-12 py-1 flex justify-center items-center gap-2">
