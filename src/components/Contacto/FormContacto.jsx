...
const FormContacto = () => {
  return (
    <form className="hidden px-2 pt-4 pb-3 shadow w-[100%] bg-white xl:px-5 formContact rounded-[6px] sm:w-[80%] md:w-[75%]  xl:w-[500px]">
      <div className="mb-3">
        <p className="mb-4 text-center md:text-[1rem] xl:text-[1.125rem]  text-[#028891]">Envíame un mensaje y estaré encantado en responderte.</p>
        <label htmlFor="name" className="block md:text-[1rem] xl:text-[1.125rem]  text-[#028891]">Nombre y Apellido</label>
        <Form.Control
          id="name"
      ...
      <div className="mb-3" >
        <label htmlFor="email" className="block md:text-[1rem] xl:text-[1.125rem]  text-[#028891]">Email</label>
        <Form.Control
          id="email"
      ...
      <div className="mb-3 ">
        <label htmlFor="subject" className="block md:text-[1rem] xl:text-[1.125rem]  text-[#028891]">Asunto</label>
        <Form.Control
          id="subject"
          className="block py-2 border-b-[1px] input w-[100%] border-[#028891]"
          type="text"
      ...
      <div className="mb-3">
        <Form.Label htmlFor="message" className="block mb-1 md:text-[1rem] xl:text-[1.125rem]  text-[#028891]">Mensaje</Form.Label>
        <Form.Control
          as="textarea"
