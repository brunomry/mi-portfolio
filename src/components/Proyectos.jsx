...
const Proyectos = () => {
  ...
  return (
    <article
      className=" py-4 py-md-5 d-flex flex-column gap-2 gap-sm-5 justify-content-center align-items-center px-3 section proyects  rounded-2 shadow"
      id="proyectos"
    >
      <h2 className=" mb-3 text-center">Proyectos</h2>
