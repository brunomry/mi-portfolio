  ...
  return (
    ...
    >
      ...
      <Tabs
        activeKey={key}
        onSelect={(k) => setKey(k)}
        className="flex flex-col sm:flex-row px-2 gap-1 xl:gap-5 py-3 lg:mb-5 xl:px-12 items-center rounded-[25px] tabs text-[#028891] bg-[#e0dffd]  md:text-[1rem] lg:text-[18px] "
      >
        <Tab
          eventKey="all"
          title="Todos"
