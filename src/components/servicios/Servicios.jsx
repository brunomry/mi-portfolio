...
function Servicios() {
  return (
    ...
    >
      ...
      <div className="flex w-[100%] md:flex-row md:flex-wrap md:gap-2 xl:w-[100%] 2xl:w-[75%] containerServices h-[250px] mt-8 sm:h-[100%] pb-[20px] md:justify-center md:items-center gap-3 lg:gap-3 2xl:gap-5 ">
