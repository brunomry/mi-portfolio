...
const CardCertificacion = ({ servicio }) => {
  return (
    <div
      className="rounded-[6px] bg-[#fff] py-8 w-[100%] min-w-[260px] md:max-w-[300px] min-h-[225px] xl:h-[250px]  duration-[0.8s] border-[1px] border-b-[#000] border-b-[5px] text-center md:text-start flex flex-col px-2 md:px-4 xl:px-5 lg:hover:shadow-xl"
