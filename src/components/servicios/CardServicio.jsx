...
const CardCertificacion = ({ servicio }) => {
  return (
    <div
      className="rounded-[8px] bg-[#2B7FF7] w-[100%] min-w-[260px] md:max-w-[340px] lg:max-w-[375px] min-h-[150px]  xl:max-w-[450px] duration-[0.8s]  md:text-start flex flex-col px-2 md:px-0 xl:px-5"
